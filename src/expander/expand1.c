...
/*   Updated: 2025/05/01 15:01:06 by marianamest      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//             else if(!ft_isalnum(input[i]))
	// se o primeiro char nao for valido
//             {
...
char	*find_var_name2(char *input, int size_of_var_name)
		// finds var name in the input string
{
	int i;
	int j;
	char *var_name;
...
char	*find_var_in_env(char *input, char *var_name, char **env)
		// looks through the env to find the var value
{
	int i;
	char *var_value;
...
char	*delete_number_and_dollar_sign(char *input, int dollar_index)
		// deletes the number and dollar sign from the input
{
	char *new_input;
	int j;
...
char	*delete_dollar_sign(char *input, int dollar_index)
		// deletes the dollar sign from the input
{
	char *new_input;
	int j;
